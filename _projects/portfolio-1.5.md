...
<table width="100%"><tr>
    ...
    <img src='/images/feedback control step.png' alt='Step response' width='500px'> <img src='/images/system response to ramp.png' alt='Ramp vs System response' width='500px'>
collection: projects
---
[Click here]( https://harshmeel.github.io/files/Earth temperature feedback control.pdf) for detailed report of the project.
